        ...
        if (_ct3 == (256*_T_i2 + 255))
          {
              ...
              for (int _i2 = (256 * _T_i2); (_i2 <= _ct3); _i2 = (_i2 + 8))
              {
                ...
                _mm256_storeu_ps (&_buf_2_2[((_i0 * (1 * 256)) + ((-256 * _T_i2) + _i2))],
                                  _mm256_add_ps (_buf_1_1_vec, 
                                                 _mm256_i32gather_ps (_arr_4_0, _ct12_vec, 4)));
              }
          }
          else
          {
      ...
      if (_ct11 == 256*_T_i2 + 255)
        {
            ...
            for (int _i2 = (256 * _T_i2); (_i2 < _ct11+1); _i2 = (_i2 + 8))
            {
                ...
                __m256 res = _mm256_add_ps(_mm256_mul_ps (_mm256_i32gather_ps (_buf_2_2, _ct50_index, 4),
                                                          _1subct15sub50), 
                                           _mm256_mul_ps (_mm256_i32gather_ps (_buf_2_2, _ct50_1_index, 4),
                                                          _ct15sub50));
